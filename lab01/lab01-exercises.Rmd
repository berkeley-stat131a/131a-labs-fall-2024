...
- You will submit both (1) a .Rmd file with your code and (2) a PDF containing the code and output. 
- You can generate a PDF in RStudio by pressing `Knit` and then `Knit to PDF`.
