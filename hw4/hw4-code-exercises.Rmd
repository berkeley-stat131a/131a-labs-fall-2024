...
Fit a linear regression model predicting the undermatching rate from the high school ID and Naviance access.
...
-   Why is the CV-estimated RMSE higher than the in-sample RMSE, **but to a lesser extent than the out-of-sample RMSE**?
